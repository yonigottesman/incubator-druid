...
public class OakIncrementalIndexReadOnlyRow extends IncrementalIndexRow
{
  ...
  public OakIncrementalIndexReadOnlyRow(OakRBuffer oakRBuffer, List<DimensionDesc> dimensionDescsList)
  {
